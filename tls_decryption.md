...
- On a device rooted with Magisk, you can install the [movecert module](https://github.com/Magisk-Modules-Repo/movecert), then install the PCAPdroid CA as a user certificate and reboot so it is moved into the system store. This is the suggested solution if you have Magisk
