...
The "Edit Filter" dialog allows you to specify one or more filters:
...
The active filters are shown via chips above the connections list, which provide a convenient way to remove filters.
