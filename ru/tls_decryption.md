...
**Примечание**: начиная с версии PCAPdroid 2.0.1, если вы установили PCAPdroid из Google Play, вам необходимо скачать APK дополнения со [страницы релизов дополнения](https://github.com/emanuele-f/PCAPdroid-mitm/releases) и установить его вручную; при выходе новой версии обновлять его также придется вручную. Пока дополнение не установлено, настройка "Дешифрование TLS" скрыта. Это изменение сделано для соответствия политикам Google Play, которые не приветствуют загрузку APK за пределами Google Play. Сборки из F-Droid и Github не затронуты, в них дополнение по-прежнему устанавливается и обновляется через помощник настройки.
