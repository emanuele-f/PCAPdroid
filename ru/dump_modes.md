**[Оглавление](index)	>	Режимы дампирования траффика**
...
Данный режим является "продвинутым" и предназначен специально для того, чтобы проводить анализ траффика в реальном времени. В этом режиме PCAPdroid инкапсулирует PCAP записи в UDP поток, отсылаемый на удаленый UDP приемник. IP и порт приемника могут быть заданы в настройках PCAPdroid.
